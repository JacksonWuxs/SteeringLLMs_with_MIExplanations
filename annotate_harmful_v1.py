...
class ToxicalJudge:
    def __init__(self, key):
        instruct = "You are a cybersecurity expert.\n"+\
                   ...
                   "along with its example words, reflects a harmful behavior or an unsafe intent, " +\
    ...
    def clean(self, case):
        temp = case[0].lower().split("unsafe:")[-1].rsplit(".")[0]
...
if __name__ == "__main__":
    ...
    with open(file.rsplit(".", 1)[0] + "_harmfulV1.tsv", "w", encoding="utf8") as f:
